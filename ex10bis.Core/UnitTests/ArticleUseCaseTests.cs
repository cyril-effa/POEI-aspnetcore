...
namespace UnitTests
{
    ...
    public class ArticleUseCaseTests
    {
        ...
        public void Create_ShouldReturnSuccess_WhenArticleIsCreated()
        {
            ...
            // Act
            var result = new ArticleUseCase(fakeRepository.Object).Create(request).Result;
        ...
        public void Read_ShouldReturnArticle_WhenIdExists()
        {
            ...
            // Act
            var result = new ArticleUseCase(fakeRepository.Object).Read(request).Result;
        ...
        public void Edit_ShouldReturnSuccess_WhenArticleIsUpdated()
        {
            ...
            // Act
            var result = new ArticleUseCase(fakeRepository.Object).Edit(request).Result;
        ...
        public void Delete_ShouldReturnSuccess_WhenArticleIsDeleted()
        {
            ...
            // Act
            var result = new ArticleUseCase(fakeRepository.Object).Delete(new DeleteArticleRequest(1)).Result;

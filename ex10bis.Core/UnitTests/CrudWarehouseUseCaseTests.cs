...
{
    [TestClass]
    public sealed class CrudWarehouseUseCaseTests
    {
        [TestMethod]
        public void Create_ShouldReturnSuccess_WhenWarehouseIsCreated()
        {
            ...
            // Act
            var result = new CrudWarehouseUseCase(fakeRepository.Object).Create(request).Result;
        ...
        public void Read_ShouldReturnWarehouse_WhenIdExists()
        {
            ...
            // Act
            var result = new CrudWarehouseUseCase(fakeRepository.Object).Read(request).Result;
        ...
        public void Edit_ShouldReturnSuccess_WhenWarehouseIsUpdated()
        {
            ...
            // Act
            var result = new CrudWarehouseUseCase(fakeRepository.Object).Edit(request).Result;
        ...
        public void Delete_ShouldReturnSuccess_WhenWarehouseIsDeleted()
        {
            ...
            // Act
            var result = new CrudWarehouseUseCase(fakeRepository.Object).Delete(request).Result;
